...
class MainWindow(QtGui.QMainWindow):
    ...
    def __init__(self, samples=Constants.argument_default_samples):
        ...
        #sm.open_source()._enable(True,False,0)
...
# =============================================================================
    ...
    def Start_Injection(self):
        ...
        while (time.time() < t_end) and not(Stop_Injection_Bool):
            pass
    ...
    def start_camera(self):
        self.window = pygetwindow.getWindowsWithTitle('OLYMPUS DP2-TWAIN')[0]
        
        self.captTop = 56
        self.captLeft = 0
        self.captHeight = self.window.height - 77-38
        self.captWidth = self.window.width-233-16
        
        self.captScreen = QtWidgets.QApplication.primaryScreen()
        self.timer.start()
    ...
    def update_frame(self):
        if self.captScreen:
            img = self.captScreen.grabWindow(self.window._hWnd, self.captLeft, self.captTop, self.captWidth, self.captHeight)
    ...
    def displayImage(self, img, window=True):
        ...
        if window:
            ...
            self.ui.imgLabel.setPixmap(img.scaled(200, 200))
...
# =============================================================================
    ...
    def _configure_signals(self):
        ...
        ##############################################################################
        # Injection
        self.Injection_Thread = threading.Thread(target=self.Start_Injection)
        ...
        self.ui.pButton_Start_Injection.clicked.connect(self.Injection_Thread.start)
