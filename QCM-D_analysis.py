...
if len(header) == 6:
    ...
    plt.title('Plot of Resonance Frequency (Single Scan)')
    ...
    plt.title('Plot of dissipation (Single Scan)')
...
################################################################
    ...
    plt.xlabel("Relative Time (s)")
    plt.title('Plot of Resonance Frequency (Multi Scan)')
    plt.legend()
    ...
    plt.xlabel("Relative Time (s)")
    plt.title('Plot of dissipation (Multi Scan)')
    plt.legend()
